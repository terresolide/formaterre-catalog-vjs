...
div.wrapper-group{
  ...
  div.element-flex  div.more-info {
   position:absolute;
   height: 30px;
  text-align: center;
  width: 100%;
  ...
  div.element-flex  div.more-info a:hover {
  ...
  figure div {
    ...
    pointer-events:none;
    font-size:1.4rem;
    text-shadow: 2px 2px 10px #000; /* horizontal-offset vertical-offset 'blur' colour */
